                        ...
                        <div class="data-tables datatable-dark">
                            <table id="dataTable" class="text-center">
                                ...
                                <tr>
                                    ...
                                    <td>ccc@abc.com</td>
                                    <td>
                                        <button type="button" class="btn btn-secondary btn-lg btn-rounded me-2" data-bs-toggle="modal" data-bs-target="#exampleModal">Info</button>

                                        <div class="modal fade modal-xl" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h1 class="modal-title fs-5" id="exampleModalLabel">Venue List of the Booking</h1>
                                                            ...
                                                            <div class="data-tables datatable-dark">
                                                                <table id="dataTable3" class="text-center">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <input type="checkbox" class="btn-check" id="check-in-3" checked autocomplete="off">
                                                                            <label class="btn btn-warning" for="check-in-3">Check-in</label>
                                                                            <input type="checkbox" class="btn-check" id="check-out-3" checked autocomplete="off" disabled>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>97684664</td>
                                                                        <td>
                                                                            <input type="checkbox" class="btn-check" id="approval-approval-4" checked autocomplete="on">
                                                                            <label class="btn btn-success" for="approval-approval-4">Approval</label>
                                                                            <input type="checkbox" class="btn-check" id="approval-reject-4" checked autocomplete="off" disabled>
                                                                            <label class="btn btn-danger" for="approval-reject-4">Reject</label>
                                                                        </td>
                                                                        <td>
                                                                            <input type="checkbox" class="btn-check" id="check-in-4" checked autocomplete="on" disabled>
                                                                            <label class="btn btn-warning" for="check-in-4">Check-in</label>
                                                                            <input type="checkbox" class="btn-check" id="check-out-4" checked autocomplete="off">
